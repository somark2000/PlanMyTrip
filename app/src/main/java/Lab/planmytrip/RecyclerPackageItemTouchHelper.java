...
public class RecyclerPackageItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    private PackageItemAdapter adapter;

    public RecyclerPackageItemTouchHelper(PackageItemAdapter adapter) {
    ...
    public void onSwiped(@NonNull final RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (direction == ItemTouchHelper.LEFT) {
            ...
            builder.setTitle("Delete PackageItem");
